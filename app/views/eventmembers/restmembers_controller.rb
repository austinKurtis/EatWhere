class RestmembersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @restmember.save
        format.html { redirect_to @restmember, notice: 'Restmember was successfully created.' }
  ...
  private
    ...
    def restmember_params
      params.require(:restmember).permit(:restaurant_id, :event_id)
    end
end
